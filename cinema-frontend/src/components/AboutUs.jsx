                        ...
                        <Col sm={9}>
                            <Tab.Content>
                                <Tab.Pane eventKey="first">
                                    ...
                                    <center>
                                        <Button variant="outline-dark" href="https://github.com/AmanBassi">GitHub</Button>
                                        <Button variant="outline-dark" href="https://www.qa.com/">Company</Button>
                                    </center>
                                </Tab.Pane>
                                <Tab.Pane eventKey="second">
                                    ...
                                    <center>
                                        <Button variant="outline-dark" href="https://github.com/JamesBarnett44">GitHub</Button>
                                        <Button variant="outline-dark" href="https://www.qa.com/">Company</Button>
                                    </center>
                                </Tab.Pane>
                                <Tab.Pane eventKey="third">
                                    ...
                                    <center>
                                        <Button variant="outline-dark" href="https://github.com/sgtnamder">GitHub</Button>
                                        <Button variant="outline-dark" href="https://www.qa.com/">Company</Button>
                                    </center>
                                </Tab.Pane>
                                <Tab.Pane eventKey="fourth">
                                    ...
                                    <center>
                                        <Button variant="outline-dark" href="https://github.com/Diakoptes24">GitHub</Button>
                                        <Button variant="outline-dark" href="https://www.qa.com/">Company</Button>
                                    </center>
                                </Tab.Pane>
                            </Tab.Content>
